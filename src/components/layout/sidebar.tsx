...
export function SideBarLink({ href, icon, label, isCurrentPath }: SideBarLink) {
  return (
    <Link
      href={href}
      className={cn(
        "hover:bg-accent-hover group flex w-full items-center rounded px-4 py-2.5 focus:border-gray-900 focus:outline-transparent xl:gap-3",
        {
...
export default function SideBar({
  ...
  return (
    <div
      className={cn("bg-foreground dark:bg-background relative px-4", {
