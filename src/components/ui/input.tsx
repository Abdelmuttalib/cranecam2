...
const inputVariants = cva(
  "relative text-lg border-0 transition-colors focus:outline-transparent transition duration-200 disabled:pointer-events-none disabled:opacity-60 disabled:hover:opacity-60 disabled:cursor-not-allowed disabled:shadow-none ring-1 ring-transparent ring-inset focus:ring-2 focus:ring-inset outline-none focus:outline-none w-full rounded focus:outline-transparent focus:ring-2 focus:ring-inset focus:outline-none disabled:bg-layer-3 disabled:hover:disabled:bg-background-muted/30 disabled:text-foreground-muted disabled:placeholder:text-foreground-muted",
  {
    variants: {
      variant: {
        default:
          "ring-1 ring-inset shadow-sm ring-input-border text-sm px-3 py-2 text-foreground placeholder-foreground-muted outline-none dark:bg-layer-2 dark:hover:bg-layer-3 focus:ring-primary focus:bg-layer-2",
        //  focus:ring-offset-2 focus:ring-offset-primary-100
        transparent:
          "bg-transparent text-foreground placeholder-foreground-muted hover:bg-layer focus:ring-transparent",
      },
      size: {
        default: "px-3 h-10 md:px-4",
